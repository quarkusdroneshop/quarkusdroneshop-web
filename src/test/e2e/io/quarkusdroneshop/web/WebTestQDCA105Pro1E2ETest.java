...
public class WebTestQDCA105Pro1E2ETest {
  public static void main(String[] args) {
    try (Playwright playwright = Playwright.create()) {
      ...
      // QDC-A105-Pro01 is the 6th Add button (nth 5)
      page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Add")).nth(5).click();
