...
public class WebTestQDCA104ATE2ETest {
  public static void main(String[] args) {
    try (Playwright playwright = Playwright.create()) {
      ...
      // QDC-A104-AT is the 5th Add button (nth 4)
      page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Add")).nth(4).click();
