...
public class WebTestQDCA104ACE2ETest {
  public static void main(String[] args) {
    try (Playwright playwright = Playwright.create()) {
      ...
      // QDC-A104-AC is the 4th Add button (nth 3)
      page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Add")).nth(3).click();
